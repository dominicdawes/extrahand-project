...
import { GithubJob } from "@/lib/api"; // TS interface import
import { ClockIcon, GlobeIcon} from '../common/icon'; //  material icons import
import { fromToday } from '../../lib/date'  // math function import
